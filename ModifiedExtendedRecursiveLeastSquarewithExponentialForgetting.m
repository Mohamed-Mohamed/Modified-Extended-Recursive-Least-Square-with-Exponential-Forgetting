function [ Guz, Gez ] = ModifiedExtendedRecursiveLeastSquarewithExponentialForgetting ( u, y, na, nb, d, nc, lambda, Ts, Plot )
% this function is used to estimate the parameter of the system
% by using Modified Extended RLS with Exponential Forgetting  method
...
for i=2:length(y)
        ...
        theta_hat(:,i)=theta_hat(:,i-1)+K{i}*epslon_n(i);
